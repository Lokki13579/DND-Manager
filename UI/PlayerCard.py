...
class Ui_PlayerCard(QFrame):
    needToSend = pyqtSignal()
            ...
            for name, count in self.character.spellCells.items():
                try:
                    maxCellsCount: str = (
                        ...
                        .get(
                            "MaxspellCells",
                            self.character.Stats.get("otherStats").get(
                                "Ячейки заклинаний"
                            ),
                        )
                        .get(str(name))
                    ...
                    try:
                        maxCellsCount: str = self.character.Stats.get("otherStats").get(
                            "MaxspellCells",
                            self.character.Stats.get("otherStats").get(
                                "Ячейки заклинаний"
                            ),
    ...
    def setupSecondary(self):
        ...
        self.secondaryWidget.setGeometry(QRect(10, 110, 700, 351))
        self.secondaryInfo = QHBoxLayout(self.secondaryWidget)
        self.SpellCells = QGroupBox()
        self.SpellCells.setGeometry(QRect(10, 110, 200, 351))
        self.SpellCells.setObjectName("SpellCells")
        self.secondaryInfo.addWidget(self.SpellCells)
        self.AllCells = QFrame(parent=self.SpellCells)
        self.AllCells.setGeometry(QRect(15, 35, 170, 301))
        self.AllCells.setMinimumSize(QSize(0, 0))
        self.AllCells.setStyleSheet("background-color: rgb(124, 124, 124);")
        self.AllCells.setObjectName("AllCells")
        self.AllCellsLayout = QVBoxLayout(self.AllCells)
        self.AllCellsLayout.setSpacing(2)
        self.AllCellsLayout.setObjectName("AllCellsLayout")

        self.StatusData = QGroupBox()
        self.StatusData.setGeometry(QRect(220, 110, 300, 351))
        ...
        buttonSize = QSize(80, 60)
        self.buttonsLayout.setSpacing(6)
        self.healthButton = QPushButton(parent=self)
        ...
        self.dicesButton = QPushButton(parent=self)
        ...
        self.invButton = QPushButton(parent=self)
        ...
        self.spellsButton = QPushButton(parent=self)
    ...
    def setupUi(self):
        ...
        self.layoutWidget.setGeometry(QRect(10, 10, 700, 100))
        self.layoutWidget.setObjectName("layoutWidget")
        self.PrimaryInfo = QHBoxLayout(self.layoutWidget)
        self.PrimaryInfo.setContentsMargins(0, 0, 0, 0)
        self.PrimaryInfo.setSpacing(5)
        self.PrimaryInfo.setObjectName("PrimaryInfo")
        self.NameArea = QFrame(parent=self.layoutWidget)
        self.NameArea.setMinimumSize(QSize(340, 85))
        self.NameArea.setMaximumSize(QSize(16777215, 85))
        self.NameArea.setStyleSheet("background-color: rgb(42, 42, 42);")
        self.NameArea.setObjectName("NameArea")
        self.horizontalLayout = QHBoxLayout(self.NameArea)
        self.horizontalLayout.setSpacing(20)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.NameText = QLabel(parent=self.NameArea)
        self.NameText.setMaximumSize(QSize(16777215, 60))
        self.NameText.setAlignment(
        ...
        self.LevelData = QVBoxLayout()
        self.LevelData.setObjectName("LevelData")
        self.LevelText = QPushButton(parent=self.NameArea)
        self.LevelText.setMinimumSize(QSize(0, 42))
        self.LevelText.setMaximumSize(QSize(85, 16777215))
        ...
        self.ExpText = QLabel(parent=self.NameArea)
        self.ExpText.setStyleSheet("font-size: 13pt;")
        self.ExpText.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.MainChars = QFrame(parent=self.layoutWidget)
        self.MainChars.setStyleSheet(
            "background-color: rgb(85, 85, 85); font-size: 18px;"
        )
        self.MainChars.setMinimumSize(355, 100)
        self.MainChars.setMaximumSize(355, 100)
        self.MainChars.setObjectName("MainChars")
        self.layoutChars = QGridLayout(self.MainChars)
        self.layoutChars.setObjectName("layoutChars")
        self.BGText = QLabel(parent=self.MainChars)
        self.BGText.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.BGText.setWordWrap(True)
        self.BGText.setObjectName("BGText")
        self.layoutChars.addWidget(self.BGText, 1, 1, 1, 1)
        self.RaceText = QLabel(parent=self.MainChars)
        self.RaceText.setStyleSheet("")
        self.RaceText.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.RaceText.setObjectName("RaceText")
        self.layoutChars.addWidget(self.RaceText, 0, 1, 1, 1)
        self.ClassText = QLabel(parent=self.MainChars)
        self.ClassText.setStyleSheet("")
        self.ClassText.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.ClassText.setObjectName("ClassText")
        self.layoutChars.addWidget(self.ClassText, 0, 0, 1, 1)
        self.WVText = QLabel(parent=self.MainChars)
        self.WVText.setStyleSheet("")
        self.WVText.setAlignment(Qt.AlignmentFlag.AlignCenter)
